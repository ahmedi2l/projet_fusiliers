...
public class IteratedLocalSearch {
	...
	public IteratedLocalSearch(int maxNbEval) {
		...
		String outfile = "/home/ahmed/workspace/projet_fusiliers/solutions_IteratedLocalSearch/";
		...
		try {
			PrintWriter printwriter = new PrintWriter(new BufferedWriter(new FileWriter(outfile+"/ils_regles.dat")));
